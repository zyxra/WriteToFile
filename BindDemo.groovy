 ...
 */
class QuickTest {
    @FXBindable String qtText = "Quick Test"//двунаправленность
...
start {
    ...
    stage(title: "GroovyFX Bind Demo", x: 100, y: 100, width: 400, height: 400, visible: true,
        ...
        scene(fill: GROOVYBLUE) {
            vbox(spacing: 10, padding: 10) {
                ...
                label(text: bind(tf.textProperty()))//метод GETTER
    ...
    bind bind1.text() to bind2.text() to qt,"qtText"  using {"Converted: ${it}"} //зарезервир.слово it
}
